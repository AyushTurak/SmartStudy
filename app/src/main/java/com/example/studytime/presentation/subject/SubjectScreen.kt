...
import com.example.studytime.presentation.components.studySessionsList
...
fun SubjectScreenRoute(
    ...
    SubjectScreen(
        ...
        onAddTaskButtonClick = {
            ...
            navController.navigate("task_screen/${navArg.taskId}/${navArg.subjectId}")
        },
...
fun SubjectOverviewSection(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "$studiedHours/${goalHours} hours",
